...
urlpatterns = [
    ...
    path('observability/grafana/test/', observability_views.grafana_test_connection, name='observability-grafana-test'),
    path('observability/grafana/discover/', observability_views.grafana_discover, name='observability-grafana-discover'),
    path('observability/grafana/embed-token/', observability_views.grafana_embed_token, name='observability-grafana-embed-token'),
    path('observability/grafana/dashboard/panels/', observability_views.grafana_dashboard_panels, name='observability-grafana-dashboard-panels'),
