...
export const testGrafanaConnection = (data = {}) => request.post('/observability/grafana/test/', data)
export const discoverGrafanaDashboards = (data = {}) => request.post('/observability/grafana/discover/', data)
export const getGrafanaEmbedToken = () => request.post('/observability/grafana/embed-token/', {})
export const getGrafanaDashboardPanels = (uid) => request.get('/observability/grafana/dashboard/panels/', { params: { uid } })
